...
#if !defined(EXCLUDE_DSP_LINEAR_INTERP_Q15)

#include "dsplib_primitives.h"

#pragma Code("dsplib_dsp_linear_interp_q15")
 /**
 * q15 LINEAR INTERPOLATION PROCESSING FUNCTION
 *
 * \param pYTable - pointer to q15 y=f(x) values 
...
#endif //!defined(EXCLUDE_DSP_LINEAR_INTERP_Q15)
