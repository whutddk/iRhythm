...
#if !defined(EXCLUDE_CMPL_DSP_MAT_ADD_F32)
#pragma Code("dsplib_dsp_cmpl_mat_add_f32")

/**
 * Floating-point complex matrix addition.
 *
...
#endif //!defined(EXCLUDE_DSP_CMPL_MAT_ADD_F32)
