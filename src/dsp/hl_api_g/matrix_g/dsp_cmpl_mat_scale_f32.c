...
#if !defined(EXCLUDE_DSP_CMPL_MAT_SCALE_F32)
#pragma Code("dsplib_dsp_cmpl_mat_scale_f32")

/**
 * Floating-point complex matrix scaling.
 *
...
#endif //!defined(EXCLUDE_DSP_CMPL_MAT_SCALE_F32)
