...
#if !defined(EXCLUDE_DSP_CMPL_MAT_TRANS_F32)
#pragma Code("dsplib_dsp_cmpl_mat_trans_f32")
...
{
    int32_t c,r;
    PTR(f32_t) __restrict dst = (PTR(f32_t))pDst->pData;
    PTR(f32_t) __restrict src = (PTR(f32_t))pSrc->pData;
