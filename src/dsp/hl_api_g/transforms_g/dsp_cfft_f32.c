...
#if !defined(EXCLUDE_DSP_CFFT_F32)
#pragma Code("dsplib_dsp_cfft_f32")
...
dsp_status _DSPLIB_XYCC dsp_cfft_init_f32(cfft_f32_t* handle, uint32_t length,  PTR(f32_t) pState)
{
    ...
    handle->ptwd  = (f32_t*)(pState);
    handle->ptwd3 = (f32_t*)(pState + dsp_cfft_getsize_f32(length)/2);
    memcpy(handle->ptwd, dsp_cfft_f32_twd_tab[order - DSP_MIN_TRANSFORM_ORDER], dsp_cfft_getsize_f32(length)/2);
    memcpy(handle->ptwd3, dsp_cfft_f32_twd3_tab[order - DSP_MIN_TRANSFORM_ORDER], dsp_cfft_getsize_f32(length)/2);
#else
...
void risc_dsp_cfft_sradix_dit_f32(const cfft_f32_t* handle, f32_t* input, f32_t* output)
{
    int32_t i, k, l;
    ...
    while (ix < nLength - 1) {
		...
		_set_agu_os0(id*2 - 4 + 1);
			...
			for (i = 0; i<i_cnt; i++) {
				...
				_st_agu_u5( _as_uint32( SUB_F32(_as_float(_agu_u2()), im3) ) );
				_st_agu_u7( _as_uint32( ADD_F32(_as_float(_agu_u3()), im3) ) );
				_st_agu_u6( _as_uint32( ADD_F32(_as_float(_agu_u2()), re3) ) );
				_st_agu_u8( _as_uint32( SUB_F32(_as_float(_agu_u4()), re3) ) );
			}
        ix = 2 * id - 4;
        id = 4 * id; ido +=2;
    }
				...
				while (ix < nLength - 1)
				{
					...
					for (i = 0; i<i_cnt; i++)
					{
						re2 = MPY_F32(_as_float(_agu_u0()), cc1_neg );
						      MAC_F32(re2, _as_float(_agu_u2()), ss1_neg );    // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1 )>>31);
						im2 = MPY_F32(_as_float(_agu_u1()), cc1_neg );
						      MSU_F32(im2, _as_float(_agu_u3()), ss1_neg );    // int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1 )>>31);

						re3 = MPY_F32(_as_float(_agu_u0()), cc3_neg );
						      MAC_F32(re3, _as_float(_agu_u2()), ss3_neg );    // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3 )>>31);
						im3 = MPY_F32(_as_float(_agu_u1()), cc3_neg );
						      MSU_F32(im3, _as_float(_agu_u4()), ss3_neg );   // int32_t tim3 = (int32_t)(( (int64_t)im3*cc3 + (int64_t)re3*ss3 )>>31);
						...
						_st_agu_u0(/*pI3[0] = */_as_uint32( ADD_F32(_as_float(_agu_u6())/*re1*/, tim3) ) );
						_st_agu_u4(/*pI3[1] = */_as_uint32( SUB_F32(_as_float(_agu_u9())/*im1*/, tre3) ) );
						_st_agu_u4(/*pI2[1] = */_as_uint32( ADD_F32(_as_float(_agu_u8())/*im0*/, tim2) ) );
						_st_agu_u1(/*pI1[1] = */_as_uint32( ADD_F32(_as_float(_agu_u7())/*im1*/, tre3) ) );
						_st_agu_u4(/*pI1[0] = */_as_uint32( SUB_F32(_as_float(_agu_u9())/*re1*/, tim3) ) );
		...
		_set_agu_ap2(handle->ptwd);
			...
			for (l = 0; l < l_cnt; l++)
			{
				re2 = MPY_F32(_as_float(_agu_u0()), _as_float(_agu_u10()) );
				      MAC_F32(re2, _as_float(_agu_u2()), _as_float(_agu_u11()) );    // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1 )>>31);
				im2 = MPY_F32(_as_float(_agu_u1()), _as_float(_agu_u10()) );
				      MSU_F32(im2, _as_float(_agu_u3()), _as_float(_agu_u12()) );    // int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1 )>>31);

				re3 = MPY_F32(_as_float(_agu_u0()), _as_float(_agu_u10()) );
				      MAC_F32(re3, _as_float(_agu_u2()), _as_float(_agu_u11()) );    // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3 )>>31);
				im3 = MPY_F32(_as_float(_agu_u1()), _as_float(_agu_u10()) );
				      MSU_F32(im3, _as_float(_agu_u4()), _as_float(_agu_u13()) );   // int32_t tim3 = (int32_t)(( (int64_t)im3*cc3 + (int64_t)re3*ss3 )>>31);
            ...
            while (ix < nLength - 1) 
            {
				...
				_set_agu_ap0(output + ix*2);
					...
					for (i = 0; i<i_cnt; i++) 
					{
						...
						re2 = MPY_F32(_as_float(_agu_u0()), cc1_neg );
						      MAC_F32(re2, _as_float(_agu_u1()), ss1_neg ); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
						im2 = MPY_F32(_as_float(_agu_u0()), ss1 );
						      MAC_F32(im2, _as_float(_agu_u2()), cc1_neg );     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

						re3 = MPY_F32(_as_float(_agu_u0()), cc3_neg );
						      MAC_F32(re3, _as_float(_agu_u1()), ss3_neg ); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
						im3 = MPY_F32(_as_float(_agu_u0()), ss3 );
		...
		_set_agu_ap2(handle->ptwd3 + 1);
			...
			for (l = 0; l < l_cnt; l++) {
				...
				re2 = MPY_F32(_as_float(_agu_u0()), _as_float(_agu_u5()) );
				      MAC_F32(re2, _as_float(_agu_u1()), _as_float(_agu_u6()) );    // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1 )>>31);
				im2 = MPY_F32(_as_float(_agu_u0()), ss1 );
				...
				re3 = MPY_F32(_as_float(_agu_u0()), _as_float(_agu_u8()) );
				      MAC_F32(re3, _as_float(_agu_u1()), _as_float(_agu_u9()) );    // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3 )>>31);
				im3 = MPY_F32(_as_float(_agu_u0()), ss3 );
    ...
    while (ix < nLength - 1) {
        ...
        pI0 = output + ix*2;
            for (i = 0; i<i_cnt; i++) {
                ...
                pI0[2] = ADD_F32(re1, im3);
                pI0[3] = SUB_F32(im1, re3);
                pI0[4] = SUB_F32(re0, re2);
                pI0[5] = SUB_F32(im0, im2);
                pI0[6] = SUB_F32(re1, im3);
                pI0[7] = ADD_F32(im1, re3);
                ...
                pI0 = output + ix*2;
                    ...
                    for (i = 0; i<i_cnt; i++) {
                        ...
                        re2 = MPY_F32(tre2, cc1_neg );
                              MAC_F32(re2, tim2, ss1_neg ); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                        im2 = MPY_F32(tim2, cc1_neg );
                              MAC_F32(im2, tre2, ss1 ); //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

                        re3 = MPY_F32(tre3, cc3_neg );
                              MAC_F32(re3, tim3, ss3_neg ); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
                        im3 = MPY_F32(tim3, cc3_neg );
                              MAC_F32(im3, tre3, ss3 );  //int32_t tim3 = (int32_t)(( (int64_t)im3*cc3 + (int64_t)re3*ss3)>>31);
                        ...
                        pI1[0] = SUB_F32(re1, tim3);
                        pI1[1] = ADD_F32(im1, tre3);
                        pI2[0] = ADD_F32(re0, tre2);
                        pI2[1] = ADD_F32(im0, tim2);
                        pI3[0] = ADD_F32(re1, tim3);
                        pI3[1] = SUB_F32(im1, tre3);
                        pI0 += id*2;
                    }
                ix = 2 * id - N4_cplx*2 + l;
                id = 4 * id; ido +=2;
...
void dsp_cfft_4_f32(const cfft_f32_t* handle, const f32_t* input, f32_t* output){
    f32_t t0r, t0i;
    f32_t t1r, t1i;
    f32_t t2r, t2i;
    f32_t t3r, t3i;
    ...
    // multiply by w1 (-j)
    t3i = SUB_F32(input[6], input[2]);
	t3r = SUB_F32(input[3], input[7]);
...
void dsp_cfft_8_f32(const cfft_f32_t* handle, const f32_t* input, f32_t* output){
    const f32_t cos_pi_4 = 0.7071067811; // cos(pi/4) in Q31
    f32_t t0r, t0i;
    f32_t t1r, t1i;
    f32_t t2r, t2i;
    f32_t t3r, t3i;
    ...
    t1r_sub = ADD_F32(t4r, t4i);
    t1i_sub = SUB_F32(t4i, t4r);
    
    // multiply by w2 (-j)
    t2r_sub = SUB_F32(input[5], input[13]);
    t2i_sub = SUB_F32(input[12], input[4]);
    
    t3r_sub = SUB_F32(input[14], input[6]); // * (-1)
    t3i_sub = SUB_F32(input[7], input[15]);
    
    // multiply by w3 (-0.707 - 0.707j)
    t4r = MPY_F32(t3r_sub, cos_pi_4 );
    t4i = MPY_F32(t3i_sub, cos_pi_4 );    
    
    t3r_sub = ADD_F32(t4r, t4i);
    t3i_sub = SUB_F32(t4r, t4i);
    ...
    // multiply by -j
    t5r = SUB_F32(t1i_sub, t3i_sub);
    t5i = SUB_F32(t3r_sub, t1r_sub);
...
#pragma Off_inline(dsp_cfft_4_f32, dsp_cfft_8_f32)
...
void _DSPLIB_XYCC dsp_cfft_f32(const cfft_f32_t* handle, const PTR(f32_t) input, PTR(f32_t) output)
{
    ...
    if ( handle->length == 4 ) {
        dsp_cfft_4_f32(handle, input, output);
    } else
#endif
#if defined(DSP_CFFT_F32_8)
    if ( handle->length == 8 ) {
        dsp_cfft_8_f32(handle, input, output);
    }else
#endif
    {
        risc_dsp_cfft_sradix_dit_f32(handle, (f32_t*) input, output);
    }
}
