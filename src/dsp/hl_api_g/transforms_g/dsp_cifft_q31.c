...
#if !defined(EXCLUDE_DSP_CIFFT_Q31)
#pragma Code("dsplib_dsp_cifft_q31")
 ...
 * \param pState - pointer to state vector buffer. length of state buffer should be obtained through "dsp_cifft_getsize_q31()" function.
 * \result dsp_status
 */
...
dsp_status _DSPLIB_XYCC dsp_cifft_init_q31(cfft_q31_t* handle, uint32_t length, PTR(uint32_t) pState)
{
    ...
    handle->ptwd3 = (q31_t*)((uint8_t*)pState + dsp_cifft_getsize_q31(length)/2);
    memcpy(handle->ptwd, dsp_cfft_q31_twd_tab[order - DSP_MIN_TRANSFORM_ORDER], dsp_cifft_getsize_q31(length)/2);
    memcpy(handle->ptwd3, dsp_cfft_q31_twd3_tab[order - DSP_MIN_TRANSFORM_ORDER], dsp_cifft_getsize_q31(length)/2);
#else    
...
void risc_dsp_cifft_sradix_dit_q31(const cfft_q31_t* handle, q31_t* input, q31_t* output)
{
    int32_t i, k, l;
    ...
    while (ix < nLength - 1) {
		...
		if (unitShift) {
			for (i = 0; i<i_cnt; i++) {
				...
				_st_agu_u5( fx_add_q31(_agu_u2(), im3) >> 1);
				_st_agu_u7( fx_sub_q31(_agu_u3(), im3) >> 1);
				_st_agu_u6( fx_sub_q31(_agu_u2(), re3) >> 1);
				_st_agu_u8( fx_add_q31(_agu_u4(), re3) >> 1);
			}
        } else {
			for (i = 0; i<i_cnt; i++) {
				re2 = _agu_u0(); //pI0[4]; //COMPLEX_RE(input, i2)
				...
				_st_agu_u5( fx_add_q31(_agu_u2(), im3) );
				_st_agu_u7( fx_sub_q31(_agu_u3(), im3) );
				_st_agu_u6( fx_sub_q31(_agu_u2(), re3) );
				_st_agu_u8( fx_add_q31(_agu_u4(), re3) );
			}
		}
        ix = 2 * id - 4;
        id = 4 * id; ido +=2;
	        ...
	        for (l = 0; l < l_cnt; l++) //pCos1+=d1, pSin1+=d1, pCos3+=d3, pSin3+=d3
	        {
	            ...
	            while (ix < nLength - 1)
	            {
					...
					for (i = 0; i<i_cnt; i++)
					{
						...
						re2 = dspfx_a64msu_q31(_agu_u2(), ss1_neg, acc);    // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1 )>>31);
							  dspfx_a64mul_q31(_agu_u1(), cc1_neg, acc);
						im2 = dspfx_a64mac_q31(_agu_u3(), ss1_neg, acc);    // int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1 )>>31);

							  dspfx_a64mul_q31(_agu_u0(), cc3_neg, acc);
						re3 = dspfx_a64msu_q31(_agu_u2(), ss3_neg, acc);    // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3 )>>31);
							  dspfx_a64mul_q31(_agu_u1(), cc3_neg, acc);
						im3 = dspfx_a64mac_q31(_agu_u4(), ss3_neg, acc);   // int32_t tim3 = (int32_t)(( (int64_t)im3*cc3 + (int64_t)re3*ss3 )>>31);
						...
						_st_agu_u0(/*pI3[0] = */dspfx_sub_q31(_agu_u6()/*re1*/, tim3) >> unitShift);
						_st_agu_u4(/*pI3[1] = */dspfx_add_q31(_agu_u9()/*im1*/, tre3) >> unitShift);
						_st_agu_u4(/*pI2[1] = */dspfx_add_q31(_agu_u8()/*im0*/, tim2) >> unitShift);
						_st_agu_u1(/*pI1[1] = */dspfx_sub_q31(_agu_u7()/*im1*/, tre3) >> unitShift);
						_st_agu_u4(/*pI1[0] = */dspfx_add_q31(_agu_u9()/*re1*/, tim3) >> unitShift);
			...
			for (l = 0; l < l_cnt; l++) //pCos1+=d1, pSin1+=d1, pCos3+=d3, pSin3+=d3
			{
				...
				while (ix < nLength - 1)
				{
					...
					for (i = 0; i<i_cnt; i++)
					{
						...
						_st_agu_u0(/*pI3[0] = */dspfx_sub_q31(_agu_u6()/*re1*/, tim3));
						_st_agu_u4(/*pI3[1] = */dspfx_add_q31(_agu_u9()/*im1*/, tre3));
						_st_agu_u4(/*pI2[1] = */dspfx_add_q31(_agu_u8()/*im0*/, tim2));
						_st_agu_u1(/*pI1[1] = */dspfx_sub_q31(_agu_u7()/*im1*/, tre3));
						_st_agu_u4(/*pI1[0] = */dspfx_add_q31(_agu_u9()/*re1*/, tim3));
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
		...
		if (_Rarely(unitShiftPrev || unitShift)) {
			...
			for (l = 0; l < l_cnt; l++)
			{
				...
				re2 = dspfx_a64msu_q31(_agu_u2(), _agu_u11(), acc);    // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1 )>>31);
					  dspfx_a64mul_q31(_agu_u1(), _agu_u10(), acc);
				im2 = dspfx_a64mac_q31(_agu_u3(), _agu_u12(), acc);    // int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1 )>>31);

					  dspfx_a64mul_q31(_agu_u0(), _agu_u10(), acc);
				re3 = dspfx_a64msu_q31(_agu_u2(), _agu_u11(), acc);    // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3 )>>31);
					  dspfx_a64mul_q31(_agu_u1(), _agu_u10(), acc);
				im3 = dspfx_a64mac_q31(_agu_u4(), _agu_u13(), acc);   // int32_t tim3 = (int32_t)(( (int64_t)im3*cc3 + (int64_t)re3*ss3 )>>31);
				...
				if (unitShift || unitShiftPrev) {
					for (i = 0; i<i_cnt; i++) 
					{
						...
						im1 = _agu_u2(); //COMPLEX_IM(input, i1)
						      ...
						      dspfx_a64mul_q31(_agu_u0(), cc1_neg, acc);
						re2 = dspfx_a64mac_q31(_agu_u1(), ss1, acc);      // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
						      dspfx_a64mul_q31(_agu_u0(), ss1_neg, acc);
						im2 = dspfx_a64mac_q31(_agu_u2(), cc1_neg, acc);  // int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

						      dspfx_a64mul_q31(_agu_u0(), cc3_neg, acc);
						re3 = dspfx_a64mac_q31(_agu_u1(), ss3, acc);      // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
						      dspfx_a64mul_q31(_agu_u0(), ss3_neg, acc);
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
		...
		if (unitShiftPrev || unitShift) {
			for (l = 0; l < l_cnt; l++) {
				...
				re2 = dspfx_a64mac_q31(_agu_u1(), ss1, acc);         // int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1 )>>31);
					  dspfx_a64mul_q31(_agu_u0(), _agu_u6(), acc);
				...
				re3 = dspfx_a64mac_q31(_agu_u1(), ss3, acc);         // int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3 )>>31);
					  dspfx_a64mul_q31(_agu_u0(), _agu_u9(), acc);
...
void risc_dsp_cifft_sradix_dit_q31(const cfft_q31_t* handle, const q31_t* input, q31_t* output)
{
    int32_t i, k, l;
    int32_t nLength = handle->length;
    int32_t N4_cplx;
    ...
    if (input == output) {
        ...
        const q31_t* pInput = input;
        for (i = 0; i < nLength; i++)
        {
            q31_t *pOutput = output + tab_bit_rev[i]*2;
            *pOutput++ = *pInput++;
            *pOutput   = *pInput++;
        }
    }
    ...
    while (ix < nLength - 1) {
        ...
        if (unitShiftPrev || unitShift) {
            for (i = 0; i<i_cnt; i++) {
                ...
                pI0[2] = dspfx_sub_q31(re1, im3) >> unitShift;
                pI0[3] = dspfx_add_q31(im1, re3) >> unitShift;
                pI0[4] = dspfx_sub_q31(re0, re2) >> unitShift;
                pI0[5] = dspfx_sub_q31(im0, im2) >> unitShift;
                pI0[6] = dspfx_add_q31(re1, im3) >> unitShift;
                pI0[7] = dspfx_sub_q31(im1, re3) >> unitShift;
            ...
            for (i = 0; i<i_cnt; i++) {
                ...
                pI0[2] = dspfx_sub_q31(re1, im3);
                pI0[3] = dspfx_add_q31(im1, re3);
                pI0[4] = dspfx_sub_q31(re0, re2);
                pI0[5] = dspfx_sub_q31(im0, im2);
                pI0[6] = dspfx_add_q31(re1, im3);
                pI0[7] = dspfx_sub_q31(im1, re3);
            ...
            while (ix < nLength - 1) {
                ...
                if (unitShiftPrev || unitShift) {
                    for (i = 0; i<i_cnt; i++) {
                        ...
                        re2 = dspfx_a64mac_q31(tim2, ss1, acc); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                              dspfx_a64mul_q31(tim2, cc1_neg, acc);
                        im2 = dspfx_a64mac_q31(tre2, ss1_neg, acc); //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

                              dspfx_a64mul_q31(tre3, cc3_neg, acc);
                        re3 = dspfx_a64mac_q31(tim3, ss3, acc); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
                              dspfx_a64mul_q31(tim3, cc3_neg, acc);
                        im3 = dspfx_a64mac_q31(tre3, ss3_neg, acc);  //int32_t tim3 = (int32_t)(( (int64_t)im3*cc3 + (int64_t)re3*ss3)>>31);
                        ...
                        pI1[0] = dspfx_add_q31(re1, tim3) >> unitShift;
                        pI1[1] = dspfx_sub_q31(im1, tre3) >> unitShift;
                        pI2[0] = dspfx_add_q31(re0, tre2) >> unitShift;
                        pI2[1] = dspfx_add_q31(im0, tim2) >> unitShift;
                        pI3[0] = dspfx_sub_q31(re1, tim3) >> unitShift;
                        pI3[1] = dspfx_add_q31(im1, tre3) >> unitShift;
                        pI0 += id*2;
                    }
                } else
                {
                    for (i = 0; i<i_cnt; i++) {
                        ...
                        pI1[0] = dspfx_add_q31(re1, tim3);
                        pI1[1] = dspfx_sub_q31(im1, tre3);
                        pI2[0] = dspfx_add_q31(re0, tre2);
                        pI2[1] = dspfx_add_q31(im0, tim2);
                        pI3[0] = dspfx_sub_q31(re1, tim3);
                        pI3[1] = dspfx_add_q31(im1, tre3);
                        pI0 += id*2;
                    }
                }
                ix = 2 * id - N4_cplx*2 + l;
...
#if !defined(EXCLUDE_DSP_CIFFT_4_UNSCALED_Q31)
void dsp_cifft_4_unscaled_q31(const cfft_q31_t* handle, const q31_t* input, q31_t* output){
    q31_t t0r, t0i;
    q31_t t1r, t1i;
    q31_t t2r, t2i;
    q31_t t3r, t3i;
    ...
    // multiply by w1 (j)
    t3r = dspfx_sub_q31(input[7], input[3]);
    t3i = dspfx_sub_q31(input[2], input[6]);
...
#if !defined(EXCLUDE_DSP_CIFFT_8_UNSCALED_Q31)
void dsp_cifft_8_unscaled_q31(const cfft_q31_t* handle, const q31_t* input, q31_t* output){
    ...
    t1r_sub = dspfx_sub_q31(t4r, t4i);
    t1i_sub = dspfx_add_q31(t4i, t4r);
    
    // multiply by w2 (j)
    t2r_sub = dspfx_sub_q31(input[13], input[5]);
    t2i_sub = dspfx_sub_q31(input[4], input[12]);
    
    t3r_sub = dspfx_sub_q31(input[6], input[14]);
    t3i_sub = dspfx_sub_q31(input[15], input[7]); // * (-1)
    
    // multiply by w3 (-0.707 + 0.707j)
    t4r = dspfx_a64mul_q31(t3r_sub, cos_pi_4, acc);
    t4i = dspfx_a64mul_q31(t3i_sub, cos_pi_4, acc);    
    
    t3r_sub = dspfx_sub_q31(t4i, t4r);
    t3i_sub = dspfx_add_q31(t4r, t4i);
    ...
    // multiply by j
    t5r = dspfx_sub_q31(t3i, t1i);
    t5i = dspfx_sub_q31(t1r, t3r);
    ...
    // multiply by j
    t5r = dspfx_sub_q31(t3i_sub, t1i_sub);
    t5i = dspfx_sub_q31(t1r_sub, t3r_sub);
...
#define XY_IFFT_RADIX2_Q31_THRESHOLD (((XY_REGION_SIZE/4))/sizeof(q31_t))

/**
 * Inverse Complex FFT "process" function for q31 data type
 *
 * \param handle - pointer to transform instance structure
...
#pragma Off_inline(dsp_cifft_4_unscaled_q31, dsp_cifft_8_unscaled_q31)

void _DSPLIB_XYCC dsp_cifft_q31(const cfft_q31_t* handle, const PTR(q31_t) input, PTR(q31_t) output)
{
#if defined(_ARC_AS210_mac32)
    if (handle->length > XY_IFFT_RADIX2_Q31_THRESHOLD) {
        risc_dsp_cifft_sradix_dit_q31(handle, input, output);
    } else if ( handle->length == 4 && handle->shiftBits == 0) {
        dsp_cifft_4_unscaled_q31(handle, input, output);
    } else if ( handle->length == 8 && handle->shiftBits == 0) {
        dsp_cifft_8_unscaled_q31(handle, input, output);
    } else {
...
#endif
    {
        risc_dsp_cifft_sradix_dit_q31(handle, (q31_t*) input, output);
    }
#endif
}
...
#endif //!defined(EXCLUDE_DSP_CIFFT_Q31)
