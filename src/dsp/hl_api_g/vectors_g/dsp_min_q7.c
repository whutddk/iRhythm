...
#if !defined(EXCLUDE_DSP_MIN_Q7)

#include "dsplib_primitives.h"

#pragma Code("dsplib_dsp_min_q7")
/**
 * Finds the minimum element of a Q7 vector.
 *
...
void _DSPLIB_XYCC dsp_min_q7(const __xy q7_t* __restrict pSrc, uint32_t nSamples, q7_t *pResult, uint32_t *pIndex)
{
...
#else
void dsp_min_q7(const q7_t* __restrict pSrc, uint32_t nSamples, q7_t *pResult, uint32_t *pIndex)
{
...
#endif //!defined(EXCLUDE_DSP_MIN_Q7)
