...
void _DSPLIB_XYCC dsp_q15_cast_vect_f32(PTR(f32_t) __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_q7_cast_vect_f32 (PTR(f32_t) __restrict pSrc, PTR(q7_t)  __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_q31_cast_vect_f32(PTR(f32_t) __restrict pSrc, PTR(q31_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_q31_cast_vect_q15(PTR(q15_t) __restrict pSrc, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_q7_cast_vect_q15 (PTR(q15_t) __restrict pSrc, PTR(q7_t)  __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_f32_cast_vect_q15(PTR(q15_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);

void _DSPLIB_XYCC dsp_q15_cast_vect_q7 (PTR(q7_t)  __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_q31_cast_vect_q7 (PTR(q7_t)  __restrict pSrc, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_f32_cast_vect_q7 (PTR(q7_t)  __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_abs_q15(const PTR(q15_t) __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_abs_q7(const PTR(q7_t) __restrict pSrc, PTR(q7_t) __restrict pDst, uint32_t nSamples);

    //negate vector
void _DSPLIB_XYCC dsp_negate_f32(const PTR(f32_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_negate_q31(const PTR(q31_t) __restrict pSrc, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_negate_q15(const PTR(q15_t) __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_negate_q7(const PTR(q7_t) __restrict pSrc, PTR(q7_t) __restrict pDst, uint32_t nSamples);

    //addition of 2 vectors
void _DSPLIB_XYCC dsp_add_f32(const PTR(f32_t) __restrict pSrcA, const PTR(f32_t) __restrict pSrcB, PTR(f32_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_add_q15(const PTR(q15_t) __restrict pSrcA, const PTR(q15_t) __restrict pSrcB, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_add_q7(const PTR(q7_t) __restrict pSrcA, const PTR(q7_t) __restrict pSrcB, PTR(q7_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_sub_q15(const PTR(q15_t) __restrict pSrcA, const PTR(q15_t) __restrict pSrcB, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_sub_q7(const PTR(q7_t) __restrict pSrcA, const PTR(q7_t) __restrict pSrcB, PTR(q7_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_offset_q15(const PTR(q15_t) __restrict pSrc, q15_t offset, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_offset_q7(const PTR(q7_t) __restrict pSrc, q7_t offset, PTR(q7_t) __restrict pDst, uint32_t nSamples);

    //per element multiplication of 2 vectors
void _DSPLIB_XYCC dsp_mult_f32(const PTR(f32_t) __restrict pSrcA, const PTR(f32_t) __restrict pSrcB, PTR(f32_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_mult_q31(const PTR(q31_t) __restrict pSrcA, const PTR(q31_t) __restrict pSrcB, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_mult_q15(const PTR(q15_t) __restrict pSrcA, const PTR(q15_t) __restrict pSrcB, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_mult_q7(const PTR(q7_t) __restrict pSrcA, const PTR(q7_t) __restrict pSrcB, PTR(q7_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_scale_q15(const PTR(q15_t) __restrict pSrc, q15_t   scaleFract, int8_t  shift, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_scale_q7(const PTR(q7_t) __restrict pSrc, q7_t   scaleFract, int8_t  shift, PTR(q7_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_scale_f32(const PTR(f32_t) __restrict pSrc, f32_t   scale, PTR(f32_t) __restrict pDst,  uint32_t nSamples);

    /*shift vector by N bits*/
void _DSPLIB_XYCC dsp_shift_q31(const PTR(q31_t) __restrict pSrc, int8_t  shiftBits, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_shift_q15(const PTR(q15_t) __restrict pSrc, int8_t  shiftBits, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_shift_q7(const PTR(q7_t) __restrict pSrc, int8_t  shiftBits, PTR(q7_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_dot_prod_q15(const PTR(q15_t) __restrict pSrcA, const PTR(q15_t) __restrict pSrcB, uint32_t nSamples, q63_t *result);
void _DSPLIB_XYCC dsp_dot_prod_q7(const PTR(q7_t) __restrict pSrcA, const PTR(q7_t) __restrict pSrcB, uint32_t nSamples, q31_t *result);
...
void _DSPLIB_XYCC dsp_min_q7(const PTR(q7_t) __restrict pSrc, uint32_t nSamples, q7_t *pResult, uint32_t *pIndex);

    //get minimum vector value
void _DSPLIB_XYCC dsp_max_f32(const PTR(f32_t) __restrict pSrc, uint32_t nSamples, f32_t *pResult, uint32_t *pIndex);
...
void _DSPLIB_XYCC dsp_max_q7(const PTR(q7_t) __restrict pSrc, uint32_t nSamples, q7_t *pResult, uint32_t *pIndex);

    //conjugate operates on input *sequence* (re,im)
void _DSPLIB_XYCC dsp_cmpl_conj_f32(const PTR(f32_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_cmpl_conj_q15(const PTR(q15_t) __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
    ...
    //complex dot product
void _DSPLIB_XYCC dsp_cmpl_dot_prod_q15(const PTR(q15_t) __restrict pSrcA, const PTR(q15_t) __restrict pSrcB, uint32_t nSamples, q31_t *realResult, q31_t *imagResult);
...
void _DSPLIB_XYCC dsp_cmpl_dot_prod_f32(const PTR(f32_t) __restrict pSrcA, const PTR(f32_t) __restrict pSrcB, uint32_t nSamples, f32_t *realResult, f32_t *imagResult);

    //magnitude
void _DSPLIB_XYCC dsp_cmpl_mag_f32(const PTR(f32_t) __restrict pSrc,  PTR(f32_t) __restrict pDst,  uint32_t nSamples);
void _DSPLIB_XYCC dsp_cmpl_mag_q31(const PTR(q31_t) __restrict pSrc,  PTR(q31_t) __restrict pDst,  uint32_t nSamples);
void _DSPLIB_XYCC dsp_cmpl_mag_q15(const PTR(q15_t) __restrict pSrc,  PTR(q15_t) __restrict pDst,  uint32_t nSamples);

    //magnitude squared 
void _DSPLIB_XYCC dsp_cmpl_mag_squared_f32(const PTR(f32_t) __restrict pSrc,  PTR(f32_t) __restrict pDst,  uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_cmpl_mult_cmpl_f32(const PTR(f32_t)  __restrict pSrcA, const PTR(f32_t)  __restrict pSrcB, PTR(f32_t)  __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_cmpl_mult_real_f32(const PTR(f32_t)  __restrict pSrcCmplx, const PTR(f32_t)  __restrict pSrcReal, PTR(f32_t)  __restrict pCmplxDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_mat_init_f32(matrix_f32_t *matrix, uint16_t nRows, uint16_t nColumns, PTR(f32_t) pData);
void _DSPLIB_XYCC dsp_mat_init_q31(matrix_q31_t *matrix, uint16_t nRows, uint16_t nColumns, PTR(q31_t) pData);
void _DSPLIB_XYCC dsp_mat_init_q15(matrix_q15_t *matrix, uint16_t nRows, uint16_t nColumns, PTR(q15_t) pData);
void _DSPLIB_XYCC dsp_mat_init_q7(matrix_q7_t *matrix, uint16_t nRows, uint16_t nColumns, PTR(q7_t) pData);
...
void _DSPLIB_XYCC dsp_fir_f32(fir_f32_t *inst, const PTR(f32_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_fir_q7(fir_q7_t *inst, const PTR(q7_t) __restrict pSrc, PTR(q7_t) __restrict pDst, uint32_t nSamples);
    ...
    //Complex FIR filter
#define dsp_fir_getsize_q31_complex(nTaps) (nTaps * sizeof(q31_t) * 2)
#define dsp_fir_getsize_q15_complex(nTaps) (nTaps * sizeof(q15_t) * 2)
...
void _DSPLIB_XYCC dsp_fir_interpolate_f32(fir_intdec_f32_t *inst, const PTR(f32_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
...
dsp_status _DSPLIB_XYCC dsp_biquad_cascade_df1_init_q31(iir_biquad_q31_t *inst, uint8_t numStages, const PTR(q31_t) pCoeffs, PTR(q31_t) pState, int8_t postShift);
dsp_status _DSPLIB_XYCC dsp_biquad_cascade_df1_init_q15(iir_biquad_q15_t *inst, uint8_t numStages, const PTR(q15_t) pCoeffs, PTR(q15_t) pState, int8_t postShift);
...
void _DSPLIB_XYCC dsp_biquad_cascade_df1_q31(const iir_biquad_q31_t *inst, const PTR(q31_t) __restrict pSrc, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_biquad_cascade_df1_q15(const iir_biquad_q15_t *inst, const PTR(q15_t) __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_biquad_cascade_df1_f32(const iir_biquad_f32_t *inst, const PTR(f32_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC dsp_conv_f32(const PTR(f32_t) __restrict pSrcA, uint32_t nLenA, const PTR(f32_t) __restrict pSrcB, uint32_t nLenB, PTR(f32_t) __restrict pDst);
void _DSPLIB_XYCC dsp_conv_q31(const PTR(q31_t) __restrict pSrcA, uint32_t nLenA, const PTR(q31_t) __restrict pSrcB, uint32_t nLenB, PTR(q31_t) __restrict pDst);
...
void _DSPLIB_XYCC dsp_correlate_q31(const PTR(q31_t) __restrict pSrcA, uint32_t nLenA, const PTR(q31_t) __restrict pSrcB, uint32_t nLenB, PTR(q31_t) __restrict pDst);
...
#endif
dsp_status _DSPLIB_XYCC dsp_cfft_init_f32(cfft_f32_t *handle, uint32_t length, PTR(f32_t) pState);
dsp_status _DSPLIB_XYCC dsp_cfft_init_q31(cfft_q31_t *handle, uint32_t length, PTR(uint32_t) pState);
dsp_status _DSPLIB_XYCC dsp_cfft_init_q15(cfft_q15_t *handle, uint32_t length, PTR(uint32_t) pState);
...
void _DSPLIB_XYCC dsp_cfft_f32(const cfft_f32_t *handle, const PTR(f32_t) input, PTR(f32_t) output);
void _DSPLIB_XYCC dsp_cfft_q31(const cfft_q31_t *handle, const PTR(q31_t) input, PTR(q31_t) output);
void _DSPLIB_XYCC dsp_cfft_q15(const cfft_q15_t *handle, const PTR(q15_t) input, PTR(q15_t) output);
...
dsp_status _DSPLIB_XYCC dsp_cifft_init_q31(cfft_q31_t *handle, uint32_t length, PTR(uint32_t) pState);
...
void _DSPLIB_XYCC dsp_cifft_q31(const cfft_q31_t *handle, const PTR(q31_t) input, PTR(q31_t) output);
...
void _DSPLIB_XYCC dsp_rfft_f32(const rfft_f32_t *handle, const PTR(f32_t) input, PTR(f32_t) output);
void _DSPLIB_XYCC dsp_rfft_q31(const rfft_q31_t *handle, const PTR(q31_t) input, PTR(q31_t) output);
void _DSPLIB_XYCC dsp_rfft_q15(const rfft_q15_t *handle, const PTR(q15_t) input, PTR(q15_t) output);
...
#else
#define dsp_rifft_getsize_f32(length) (dsp_cifft_getsize_f32((length)/2))
#define dsp_rifft_getsize_q31(length) (dsp_cifft_getsize_q31((length)/2))
#define dsp_rifft_getsize_q15(length) (dsp_cifft_getsize_q15((length)/2))
#endif
...
void _DSPLIB_XYCC dsp_rifft_f32(const rfft_f32_t *handle, const PTR(f32_t) input, PTR(f32_t) output);
void _DSPLIB_XYCC dsp_rifft_q31(const rfft_q31_t *handle, const PTR(q31_t) input, PTR(q31_t) output);
void _DSPLIB_XYCC dsp_rifft_q15(const rfft_q15_t *handle, const PTR(q15_t) input, PTR(q15_t) output);
...
#else
#define dsp_dct3_getsize_q31(length) ((length) * sizeof(q15_t) + dsp_cfft_getsize_q31((length)/2))
#define dsp_dct3_getsize_q15(length) ((length) * sizeof(q15_t) + dsp_cfft_getsize_q15((length)/2))
#endif
dsp_status _DSPLIB_XYCC dsp_dct3_init_q31(dct3_q31_t *handle, uint32_t length, PTR(uint32_t) pState);
...
void _DSPLIB_XYCC dsp_dct3_q31(const dct3_q31_t *handle, const PTR(q31_t) input, PTR(q31_t) output);
...
#else
#define dsp_dct4_getsize_q31(length) (dsp_cfft_getsize_q31((length)/2))
#endif
...
#else
#define dsp_dct4_getsize_q15(length) (dsp_cfft_getsize_q15((length)/2))
#endif
...
#else
#define dsp_mdct_getsize_q31(length) (dsp_cfft_getsize_q31((length)/4))
#endif
...
#else
#define dsp_mdct_getsize_q15(length) (dsp_cfft_getsize_q15((length)/4))
#endif
...
#else
#define dsp_imdct_getsize_q31(length) (dsp_cfft_getsize_q31((length)/2))
#endif
...
#else
#define dsp_imdct_getsize_q15(length) (dsp_cfft_getsize_q15((length)/2))
#endif
...
dsp_status _DSPLIB_XYCC dsp_pol_eval_init_f32(pol_f32_t *pInst, uint16_t nCoeffs, const PTR(f32_t) pCoeffs);
dsp_status _DSPLIB_XYCC dsp_pol_eval_init_q31(pol_q31_t *pInst, uint16_t nCoeffs, const PTR(q31_t) pCoeffs, int32_t shift);
dsp_status _DSPLIB_XYCC dsp_pol_eval_init_q15(pol_q15_t *pInst, uint16_t nCoeffs, const PTR(q15_t) pCoeffs, int32_t shift);
dsp_status _DSPLIB_XYCC dsp_pol_eval_init_q7(pol_q7_t *pInst, uint16_t nCoeffs, const PTR(q7_t) pCoeffs, int32_t shift);
...
void _DSPLIB_XYCC dsp_pol_eval_f32(const pol_f32_t *pInst ,const PTR(f32_t) __restrict pSrc, PTR(f32_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_pol_eval_q31(const pol_q31_t *pInst ,const PTR(q31_t) __restrict pSrc, PTR(q31_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_pol_eval_q15(const pol_q15_t *pInst ,const PTR(q15_t) __restrict pSrc, PTR(q15_t) __restrict pDst, uint32_t nSamples);
void _DSPLIB_XYCC dsp_pol_eval_q7(const pol_q7_t *pInst ,const PTR(q7_t) __restrict pSrc, PTR(q7_t) __restrict pDst, uint32_t nSamples);
...
void _DSPLIB_XYCC		dsp_cfft_radix2_q15( const cfft_q15_t *handle,  PTR(q15_t)  pInOut);
...
void _DSPLIB_XYCC       dsp_dct4_q31_ext(const dct4_q31_t *inst,  void *temp0,  PTR(q31_t)  pInPut);
...
void _DSPLIB_XYCC       dsp_dct4_q15_ext(const dct4_q15_t *inst,  void *temp0,  PTR(q15_t)  pInPut);
