...
#pragma Code("dsplib_dsp_mat_trans_q15_XtoY")
...
dsp_status dsp_mat_trans_q15_XtoY(const matrix_q15_t *pSrc, matrix_q15_t *pDst) 
{
    ...
    _set_mx00(width|AM_16BIT);
    _set_mx01(backstride|AM_16BIT);
...
#pragma Code("dsplib_dsp_mat_trans_q15_YtoX")
...
dsp_status dsp_mat_trans_q15_YtoX(const matrix_q15_t *pSrc, matrix_q15_t *pDst) 
{
    ...
    _set_my00(width|AM_16BIT);
    _set_my01(backstride|AM_16BIT);
