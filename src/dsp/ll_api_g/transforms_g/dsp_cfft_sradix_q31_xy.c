...
#pragma Code("dsplib_dsp_cfft_sradix_q31_XtoX_cfY_MAC32x32")

/**
 * split-radix Complex FFT "process" function for q31 data type
 *
    ...
    while (ix < nLength - 1) {
        ...
        if (unitShift) {
            for (i = 0; i<i_cnt; i++) {
                ...
                _set_x3_u0( dspfx_sub_q31(_x0_nu(), im3)>>1);
                _set_x2_u0( dspfx_add_q31(_x0_u0(), im3)>>1);
                _set_x3_u1( dspfx_add_q31(_x0_nu(), re3)>>1);
                _set_x2_u1( dspfx_sub_q31(_x0_u1(), re3)>>1);
            }
        } else {
            for (i = 0; i<i_cnt; i++) {
                re2 = _x1_u0(); //pI0[4]; //COMPLEX_RE(input, i2)
                ...
                _set_x3_u0( dspfx_sub_q31(_x0_nu(), im3));
                _set_x2_u0( dspfx_add_q31(_x0_u0(), im3));
                _set_x3_u1( dspfx_add_q31(_x0_nu(), re3));
                _set_x2_u1( dspfx_sub_q31(_x0_u1(), re3));
            }
        }
        ix = 2 * id - 4;
        id = 4 * id; ido +=2;
            ...
            while (ix < nLength - 1) 
            {
                ...
                if (unitShiftPrev || unitShift) {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_x2_u0( dspfx_sub_q31(re1, tim3) >> unitShift);
                        _set_x3_u0( dspfx_add_q31(im1, tre3) >> unitShift);
                        _set_x2_u0( dspfx_add_q31(re0, tre2) >> unitShift);
                        _set_x3_u0( dspfx_add_q31(im0, tim2) >> unitShift);
                        _set_x2_u1( dspfx_add_q31(re1, tim3) >> unitShift);
                        _set_x3_u1( dspfx_sub_q31(im1, tre3) >> unitShift);
                        //pI0 += id*2;
                    }
                } else {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_x2_u0( dspfx_sub_q31(re1, tim3));
                        _set_x3_u0( dspfx_add_q31(im1, tre3));
                        _set_x2_u0( dspfx_add_q31(re0, tre2));
                        _set_x3_u0( dspfx_add_q31(im0, tim2));
                        _set_x2_u1( dspfx_add_q31(re1, tim3));
                        _set_x3_u1( dspfx_sub_q31(im1, tre3));
                    }
                }
                ix = 2 * id - N4_cplx*2 + l;
                id = 4 * id; ido +=2;
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _machflw(_x1_nu(), _y1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                ...
                im2 = _machflw(_x0_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);
                      ...
                      _machflw(_x0_nu(), _y2_nu());
                       _macflw(_x1_nu(), _y3_nu());
                re3 = _machflw(_x1_nu(), _y3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_YtoY_cfX_MAC32x32")
    ...
    while (ix < nLength - 1) {
        ...
        if (unitShift) {
            for (i = 0; i<i_cnt; i++) {
                ...
                _set_y3_u0( dspfx_sub_q31(_y0_nu(), im3)>>1);
                _set_y2_u0( dspfx_add_q31(_y0_u0(), im3)>>1);
                _set_y3_u1( dspfx_add_q31(_y0_nu(), re3)>>1);
                _set_y2_u1( dspfx_sub_q31(_y0_u1(), re3)>>1);
            }
        } else {
            for (i = 0; i<i_cnt; i++) {
                re2 = _y1_u0(); //pI0[4]; //COMPLEX_RE(input, i2)
                ...
                _set_y3_u0( dspfx_sub_q31(_y0_nu(), im3));
                _set_y2_u0( dspfx_add_q31(_y0_u0(), im3));
                _set_y3_u1( dspfx_add_q31(_y0_nu(), re3));
                _set_y2_u1( dspfx_sub_q31(_y0_u1(), re3));
            }
        }
        ix = 2 * id - 4;
        id = 4 * id; ido +=2;
            ...
            while (ix < nLength - 1) 
            {
                ...
                if (unitShiftPrev || unitShift) {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_y2_u0( dspfx_sub_q31(re1, tim3) >> unitShift);
                        _set_y3_u0( dspfx_add_q31(im1, tre3) >> unitShift);
                        _set_y2_u0( dspfx_add_q31(re0, tre2) >> unitShift);
                        _set_y3_u0( dspfx_add_q31(im0, tim2) >> unitShift);
                        _set_y2_u1( dspfx_add_q31(re1, tim3) >> unitShift);
                        _set_y3_u1( dspfx_sub_q31(im1, tre3) >> unitShift);
                        //pI0 += id*2;
                    }
                } else {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_y2_u0( dspfx_sub_q31(re1, tim3));
                        _set_y3_u0( dspfx_add_q31(im1, tre3));
                        _set_y2_u0( dspfx_add_q31(re0, tre2));
                        _set_y3_u0( dspfx_add_q31(im0, tim2));
                        _set_y2_u1( dspfx_add_q31(re1, tim3));
                        _set_y3_u1( dspfx_sub_q31(im1, tre3));
                    }
                }
                ix = 2 * id - N4_cplx*2 + l;
                id = 4 * id; ido +=2;
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _machflw(_y1_nu(), _x1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                ...
                im2 = _machflw(_y0_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);
                      ...
                      _machflw(_y0_nu(), _x2_nu());
                       _macflw(_y1_nu(), _x3_nu());
                re3 = _machflw(_y1_nu(), _x3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_XtoX_cfY_MAC24x24")
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _macrt(_x1_nu(), _y1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                      _mulrt(_x1_u0(), _y0_u0());
                im2 = _macrt(_x0_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

                      _mulrt(_x0_nu(), _y2_nu());
                re3 = _macrt(_x1_nu(), _y3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_YtoY_cfX_MAC24x24")
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _macrt(_y1_nu(), _x1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                      _mulrt(_y1_u0(), _x0_u0());
                im2 = _macrt(_y0_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

                      _mulrt(_y0_nu(), _x2_nu());
                re3 = _macrt(_y1_nu(), _x3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_XtoY_cfX_MAC32x32")
    ...
    while (ix < nLength - 1) {
        ...
        if (unitShift) {
            for (i = 0; i<i_cnt; i++) {
                ...
                _set_y1_u0( dspfx_sub_q31(_y3_nu(), im3)>>1);
                _set_y0_u0( dspfx_add_q31(_y3_u0(), im3)>>1);
                _set_y1_u1( dspfx_add_q31(_y3_nu(), re3)>>1);
                _set_y0_u1( dspfx_sub_q31(_y3_u1(), re3)>>1);
            }
        } else {
            for (i = 0; i<i_cnt; i++) {
                re2 = _y2_u0(); //pI0[4]; //COMPLEX_RE(input, i2)
                ...
                _set_y1_u0( dspfx_sub_q31(_y3_nu(), im3));
                _set_y0_u0( dspfx_add_q31(_y3_u0(), im3));
                _set_y1_u1( dspfx_add_q31(_y3_nu(), re3));
                _set_y0_u1( dspfx_sub_q31(_y3_u1(), re3));
            }
        }
        ix = 2 * id - 4;
        id = 4 * id; ido +=2;
            ...
            while (ix < nLength - 1) 
            {
                ...
                if (unitShiftPrev || unitShift) {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_y0_u0( dspfx_sub_q31(re1, tim3) >> unitShift);
                        _set_y1_u0( dspfx_add_q31(im1, tre3) >> unitShift);
                        _set_y0_u0( dspfx_add_q31(re0, tre2) >> unitShift);
                        _set_y1_u0( dspfx_add_q31(im0, tim2) >> unitShift);
                        _set_y0_u1( dspfx_add_q31(re1, tim3) >> unitShift);
                        _set_y1_u1( dspfx_sub_q31(im1, tre3) >> unitShift);
                        //pI0 += id*2;
                    }
                } else {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_y0_u0( dspfx_sub_q31(re1, tim3));
                        _set_y1_u0( dspfx_add_q31(im1, tre3));
                        _set_y0_u0( dspfx_add_q31(re0, tre2));
                        _set_y1_u0( dspfx_add_q31(im0, tim2));
                        _set_y0_u1( dspfx_add_q31(re1, tim3));
                        _set_y1_u1( dspfx_sub_q31(im1, tre3));
                    }
                }
                ix = 2 * id - N4_cplx*2 + l;
                id = 4 * id; ido +=2;
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _machflw(_y2_nu(), _x1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                ...
                im2 = _machflw(_y3_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);
                      ...
                      _machflw(_y3_nu(), _x2_nu());
                       _macflw(_y2_nu(), _x3_nu());
                re3 = _machflw(_y2_nu(), _x3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_YtoX_cfY_MAC32x32")
    ...
    while (ix < nLength - 1) {
        ...
        if (unitShift) {
            for (i = 0; i<i_cnt; i++) {
                ...
                _set_x1_u0( dspfx_sub_q31(_x3_nu(), im3)>>1);
                _set_x0_u0( dspfx_add_q31(_x3_u0(), im3)>>1);
                _set_x1_u1( dspfx_add_q31(_x3_nu(), re3)>>1);
                _set_x0_u1( dspfx_sub_q31(_x3_u1(), re3)>>1);
            }
        } else {
            for (i = 0; i<i_cnt; i++) {
                re2 = _x2_u0(); //pI0[4]; //COMPLEX_RE(input, i2)
                ...
                _set_x1_u0( dspfx_sub_q31(_x3_nu(), im3));
                _set_x0_u0( dspfx_add_q31(_x3_u0(), im3));
                _set_x1_u1( dspfx_add_q31(_x3_nu(), re3));
                _set_x0_u1( dspfx_sub_q31(_x3_u1(), re3));
            }
        }
        ix = 2 * id - 4;
        id = 4 * id; ido +=2;
            ...
            while (ix < nLength - 1) 
            {
                ...
                if (unitShiftPrev || unitShift) {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_x0_u0( dspfx_sub_q31(re1, tim3) >> unitShift);
                        _set_x1_u0( dspfx_add_q31(im1, tre3) >> unitShift);
                        _set_x0_u0( dspfx_add_q31(re0, tre2) >> unitShift);
                        _set_x1_u0( dspfx_add_q31(im0, tim2) >> unitShift);
                        _set_x0_u1( dspfx_add_q31(re1, tim3) >> unitShift);
                        _set_x1_u1( dspfx_sub_q31(im1, tre3) >> unitShift);
                        //pI0 += id*2;
                    }
                } else {
                    for (i = 0; i<i_cnt; i++) 
                    {
                        ...
                        _set_x0_u0( dspfx_sub_q31(re1, tim3));
                        _set_x1_u0( dspfx_add_q31(im1, tre3));
                        _set_x0_u0( dspfx_add_q31(re0, tre2));
                        _set_x1_u0( dspfx_add_q31(im0, tim2));
                        _set_x0_u1( dspfx_add_q31(re1, tim3));
                        _set_x1_u1( dspfx_sub_q31(im1, tre3));
                    }
                }
                ix = 2 * id - N4_cplx*2 + l;
                id = 4 * id; ido +=2;
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _machflw(_x2_nu(), _y1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                ...
                im2 = _machflw(_x3_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);
                      ...
                      _machflw(_x3_nu(), _y2_nu());
                       _macflw(_x2_nu(), _y3_nu());
                re3 = _machflw(_x2_nu(), _y3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_XtoY_cfX_MAC24x24")
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _macrt(_y2_nu(), _x1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                      _mulrt(_y2_u0(), _x0_u0());
                im2 = _macrt(_y3_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

                      _mulrt(_y3_nu(), _x2_nu());
                re3 = _macrt(_y2_nu(), _x3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_q31_YtoX_cfY_MAC24x24")
    ...
    for (k = dspfx_min_q31(1, nOrder-3); k >=0 ; k--) {
        ...
        if (unitShiftPrev || unitShift) {
            for (l = 0; l < l_cnt; l++) {
                ...
                re2 = _macrt(_x2_nu(), _y1_u0()); //int32_t tre2 = (int32_t)(( (int64_t)re2*cc1 - (int64_t)im2*ss1)>>31);
                      _mulrt(_x2_u0(), _y0_u0());
                im2 = _macrt(_x3_u0(), ss1);     //int32_t tim2 = (int32_t)(( (int64_t)im2*cc1 + (int64_t)re2*ss1)>>31);

                      _mulrt(_x3_nu(), _y2_nu());
                re3 = _macrt(_x2_nu(), _y3_u0()); //int32_t tre3 = (int32_t)(( (int64_t)re3*cc3 - (int64_t)im3*ss3)>>31);
...
#pragma Code("dsplib_dsp_cfft_sradix_init_q31_cfX")

/**
 * Initializes instance structure of split-radix complex 
...
#pragma Code("dsplib_dsp_cfft_sradix_init_q31_cfY")
