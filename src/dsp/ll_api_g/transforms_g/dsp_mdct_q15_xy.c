...
#pragma Code("dsplib_dsp_mdct_preprocess_q15_XtoY")

/**
 *  MDCT preprocessing function for q15 data type
 *
...
void dsp_mdct_preprocess_q15_XtoY(uint32_t offs_input, uint32_t offs_output, uint32_t length)  
{
    ...
    _set_mx00(AM_16BIT|AM_OFFS(-3*N));
    _set_mx01(AM_16BIT|(3*N + 1));
    _set_ax1(offs_input + 3*N-1);
    _set_mx10(AM_16BIT|AM_OFFS(-N));
    _set_mx11(AM_16BIT|(N - 1));
    _set_ay0(offs_output);
    _set_my00(AM_16BIT|N);
    _set_my01(AM_16BIT|AM_OFFS(1-N));
...
#pragma Code("dsplib_dsp_mdct_preprocess_q15_YtoX")
...
void dsp_mdct_preprocess_q15_YtoX(uint32_t offs_input, uint32_t offs_output, uint32_t length)  
{
    ...
    _set_my00(AM_16BIT|AM_OFFS(-3*N));
    _set_my01(AM_16BIT|(3*N + 1));
    _set_ay1(offs_input + 3*N-1);
    _set_my10(AM_16BIT|AM_OFFS(-N));
    _set_my11(AM_16BIT|(N - 1));
    _set_ax0(offs_output);
    _set_mx00(AM_16BIT|N);
    _set_mx01(AM_16BIT|AM_OFFS(1-N));
