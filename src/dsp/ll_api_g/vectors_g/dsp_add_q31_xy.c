...
#pragma Code("dsplib_dsp_add_q31_XXtoY")

/**
 * Q31 vector addtion. Computes the addtion two vectors on
...
void dsp_add_q31_XXtoY(int32_t offs_SrcA, int32_t offs_SrcB, int32_t offs_Dst, uint32_t nSamples) 
{
    ...
    {
        _set_y0_u0( dspfx_add_q31(_x0_u0(), _x1_u0()));
        _set_y0_u0( dspfx_add_q31(_x0_u0(), _x1_u0()));
    }
    if (nSamples & 1)
        _set_y0_u0( dspfx_add_q31(_x0_u0(), _x1_u0()));
...
#pragma Code("dsplib_dsp_add_q31_YYtoX")
...
void dsp_add_q31_YYtoX(int32_t offs_SrcA, int32_t offs_SrcB, int32_t offs_Dst, uint32_t nSamples) 
{
    ...
    for (sample = 0; sample < (int32_t)nSamples>>1; sample++)
    {
        _set_x0_u0( dspfx_add_q31(_y0_u0(), _y1_u0()));
        _set_x0_u0( dspfx_add_q31(_y0_u0(), _y1_u0()));
    }
    if (nSamples & 1)
        _set_x0_u0( dspfx_add_q31(_y0_u0(), _y1_u0()));
