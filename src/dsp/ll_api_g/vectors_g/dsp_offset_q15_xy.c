...
#pragma Code("dsplib_dsp_offset_q15_XtoY")
...
{
    int32_t sample;
    q31_t offset_q31 = dspfx_asl_q31(offset, 16);
    ...
    {
        _set_y0_u0( dspfx_add_q31(_x0_u0(), offset_q31));
        _set_y0_u0( dspfx_add_q31(_x0_u0(), offset_q31));
    }
    if (nSamples & 1)
        _set_y0_u0( dspfx_add_q31(_x0_u0(), offset_q31));
...
#pragma Code("dsplib_dsp_offset_q15_YtoX")
...
void dsp_offset_q15_YtoX(int32_t offs_Src, q15_t offset, int32_t offs_Dst, uint32_t nSamples) 
{
    ...
    for (sample = 0; sample < (int32_t)nSamples>>1; sample++)
    {
        _set_x0_u0( dspfx_add_q31(_y0_u0(), offset_q31));
        _set_x0_u0( dspfx_add_q31(_y0_u0(), offset_q31));
    }
    if (nSamples & 1)
        _set_x0_u0( dspfx_add_q31(_y0_u0(), offset_q31));
