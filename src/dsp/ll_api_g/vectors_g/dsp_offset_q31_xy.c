...
#pragma Code("dsplib_dsp_offset_q31_XtoY")
...
void dsp_offset_q31_XtoY(int32_t offs_Src, q31_t offset, int32_t offs_Dst, uint32_t nSamples) 
{
    ...
    {
        _set_y0_u0( dspfx_add_q31(_x0_u0(), offset));
        _set_y0_u0( dspfx_add_q31(_x0_u0(), offset));
    }
    if (nSamples & 1)
        _set_y0_u0( dspfx_add_q31(_x0_u0(), offset));
...
#pragma Code("dsplib_dsp_offset_q31_YtoX")
...
void dsp_offset_q31_YtoX(int32_t offs_Src, q31_t offset, int32_t offs_Dst, uint32_t nSamples) 
{
    ...
    for (sample = 0; sample < (int32_t)nSamples>>1; sample++)
    {
        _set_x0_u0( dspfx_add_q31(_y0_u0(), offset));
        _set_x0_u0( dspfx_add_q31(_y0_u0(), offset));
    }
    if (nSamples & 1)
        _set_x0_u0( dspfx_add_q31(_y0_u0(), offset));
