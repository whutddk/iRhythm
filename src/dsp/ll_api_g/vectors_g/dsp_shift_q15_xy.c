...
// Produce instance with: MAC16x16; pOut - X; pIn0 - X; 

#pragma Code("dsplib_dsp_shift_q15_XtoX")
...
// Produce instance with: MAC16x16; pIn0 - X; pOut - Y; 

#pragma Code("dsplib_dsp_shift_q15_XtoY")
...
#pragma Code("dsplib_dsp_shift_q15_YtoX")
...
// Produce instance with: MAC16x16; pIn0 - Y; pOut - Y; 

#pragma Code("dsplib_dsp_shift_q15_YtoY")
